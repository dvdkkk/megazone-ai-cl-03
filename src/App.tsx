...
const coursesData: CourseTrack[] = [
  {
    ...
    detailUrl: 'https://megazone-ai-cl-01.vercel.app'
  },
  {
    id: 'architect',
    trackCode: 'TRACK 02',
    ...
    detailUrl: 'https://megazone-ai-cl-02.vercel.app'
  },
  {
    id: 'security',
    trackCode: 'TRACK 03',
    ...
    detailUrl: 'https://megazone-ai-cl-03.vercel.app'
  },
  {
    id: 'data',
    trackCode: 'TRACK 04',
    ...
    detailUrl: 'https://megazone-ai-cl-04.vercel.app'
  }
];
...
export default function App() {
  ...
  const handleFormSubmit = (e: React.FormEvent) => {
    ...
    if (!formData.name || !formData.age || !formData.phone || !formData.track) {
      setValidationError('필수 항목(이름, 나이, 연락처, 과정명)을 모두 입력해주세요.');
      return;
    }
  ...
  return (
    <div className="min-h-screen">
      ...
      <header className="header" id="header">
        <div className="header-inner">
          <div className="header-left">
            <a href="https://megazone-ai-cl.vercel.app" className="logo-wrap" id="headerLogoLink">
              <img
            ...
            <nav className="gnb-nav">
              <a href="https://megazone-ai-cl-01.vercel.app">AI 에이전트</a>
              <a href="https://megazone-ai-cl-02.vercel.app">AI 아키텍트</a>
              <a href="https://megazone-ai-cl-03.vercel.app">AI 보안</a>
              <a href="https://megazone-ai-cl-04.vercel.app">AI 데이터</a>
              <a href="#faq">FAQ</a>
            </nav>
          </div>
        ...
        <div className={`mobile-drawer ${mobileMenuOpen ? 'open' : ''}`} id="mobileDrawer">
          <a href="https://megazone-ai-cl-01.vercel.app" onClick={() => setMobileMenuOpen(false)}>AI 에이전트</a>
          <a href="https://megazone-ai-cl-02.vercel.app" onClick={() => setMobileMenuOpen(false)}>AI 아키텍트</a>
          <a href="https://megazone-ai-cl-03.vercel.app" onClick={() => setMobileMenuOpen(false)}>AI 보안</a>
          <a href="https://megazone-ai-cl-04.vercel.app" onClick={() => setMobileMenuOpen(false)}>AI 데이터</a>
      ...
      {validationError && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
          <div className="bg-[#111a2e] border border-red-500/30 p-6 md:p-8 rounded-2xl max-w-md w-full shadow-2xl text-center">
            ...
            <h3 className="text-xl font-bold text-white mb-2">입력 오류</h3>
            <p className="text-sm text-slate-300 whitespace-pre-line leading-relaxed mb-6">
              {validationError}
            </p>
            <button
              type="button"
              className="bg-red-600 hover:bg-red-500 text-white rounded-full px-6 py-2.5 font-bold transition-all w-full"
